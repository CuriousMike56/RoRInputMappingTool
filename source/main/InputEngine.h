...
enum events
{
	...
	EV_CAMERA_UP, //!< move camera up
	EV_CAMERA_DOWN, //!< move camera down
	...
	EV_COMMON_ACCELERATE_SIMULATION, //!< Speed up simulation
	EV_COMMON_DECELERATE_SIMULATION, //!< Slow down simulation
	EV_COMMON_RESET_SIMULATION_PACE, //!< Reset simulation speed 
	EV_COMMON_TOGGLE_TERRAIN_EDITOR, //!< Enter terrain editor
